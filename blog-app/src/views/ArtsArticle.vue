<template>
    <div class="mx-40  my-7 mb-16" v-for="data in state.item2" :key="data.id" >
        <div class="mr-64" >
        ...
        <div class="mt-9 -mx-20" v-for="image in images.image2" :key="image.id">
        ...
        <div class="flex flex-2 w-full mt-24 ">
            ...
            <div class=" flex flex-row w-full mr-16 mt-5 text-center h-16 ">
            ...
            <div  class="w-2/6">
                <div class="w-80">
                    ...
                    <hr class="mb-3"/>
                        <div class="flex" v-for="image in images.image2" :key="image.id">
