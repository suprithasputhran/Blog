<template>
    <div class="mx-40  my-7 mb-16" v-for="data in state.item3" :key="data.id" >
        <div class="mr-64" >
        ...
        <div class="flex justify-start w-9/12" v-for="image in images.image3" :key="image.id">
        ...
        <div class="mt-9 -mx-20" v-for="image in images.image3" :key="image.id">
        ...
        <div class="flex flex-2 w-full mt-24 ">
            ...
            <div  class="w-2/6">
                <div class="w-80">
                    ...
                    <hr class="mb-3"/>
                        <div class="flex" v-for="image in images.image3" :key="image.id">
            ...
            <div class="mt-12">
                ...
                <router-link to="/sport">
                    <div class="flex my-4 w-80 h-18" >
                        <img v-for="image in images.image1" :key="image.id" :src="image" class="mx-2 mt-2 w-24 h-16 ease-out hover:-translate-y-1 transition-all rounded-2xl  cursor-pointer " alt="author image"/>
                        <p v-for="data in state.item" :key="data.id"  class="mx-1 mt-1 text-base font-bold whitespace-break-spaces hover:underline ">{{data.attributes.Title}}</p>
                    </div>
                </router-link>
